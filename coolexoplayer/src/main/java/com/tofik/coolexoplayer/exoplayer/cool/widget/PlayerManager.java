...
/**
 * Manage the collection of {@link CoolPlayer}s for a specific {@link Container}.
 *
 * Task: collect all Players in which "{@link Common#allowsToPlay(CoolPlayer)}" returns true, then
 * initialize them.
 *
