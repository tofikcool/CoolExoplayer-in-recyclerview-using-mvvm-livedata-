...
public interface Playable {
   ...
   * @param isMute
   */
  void setPlaybackInfo(@NonNull PlaybackInfo playbackInfo, boolean isMute);
  ...
  /**
   * !This must only work if the Player in use is a {@link CoolExoPlayer}.
   */
  void addOnVolumeChangeListener(@NonNull CoolPlayer.OnVolumeChangeListener listener);

  void removeOnVolumeChangeListener(@Nullable CoolPlayer.OnVolumeChangeListener listener);
  ...
  void addErrorListener(@NonNull CoolPlayer.OnErrorListener listener);

  void removeErrorListener(@Nullable CoolPlayer.OnErrorListener listener);
