 ...
 * {@link PlaybackInfo} of {@link CoolPlayer}s. For each {@link CoolPlayer},
...
public interface CacheManager {
  ...
  /**
   * Get the unique key for the {@link CoolPlayer} of a specific order. Note that this key must
   ...
   * @return the unique key of the {@link CoolPlayer}.
   */
  @Nullable
   ...
   * @return the order of the {@link CoolPlayer} whose unique key value is key.
   */
  @Nullable
  Integer getOrderForKey(@NonNull Object key);
